...
#ifndef BUTTONQUESTION_H
#define BUTTONQUESTION_H
...
/**
 * Button question: multiple choices question.
 * Each option is represented by a button.
 * Only one option can be selected.
 */
class ButtonQuestion : public SimpleClosedQuestion
{
public:
    /**
     * Minimal constructor.
     ...
     */
    ButtonQuestion(const QString& val,
